...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [115] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym__fallback, 1, .dynamic_precedence = -100), SHIFT(21),
  [118] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym__fallback, 1, .dynamic_precedence = -100), SHIFT(32),
  ...
  [135] = {.entry = {.count = 3, .reusable = false}}, REDUCE(sym__fallback, 1, .dynamic_precedence = -100), REDUCE(sym_emphasis, 3), SHIFT(21),
  [139] = {.entry = {.count = 3, .reusable = false}}, REDUCE(sym__fallback, 1, .dynamic_precedence = -100), REDUCE(sym_emphasis, 3), SHIFT(32),
